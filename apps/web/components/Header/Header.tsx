...
export const Header = ({userId}: Props) => {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 ${mounted && isScrolled ? 'bg-[var(--color-gray-900)] bg-opacity-95 backdrop-blur-md shadow-lg' : 'bg-transparent'} transition-all duration-300`}
    >
