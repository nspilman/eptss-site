          ...
          <div className="grid grid-cols-1 gap-6 w-full">
            {submissions.map((submission) => (
              ...
              >
                ...
                {/* Card content */}
                <div className="relative flex flex-col bg-[var(--color-background-primary)] border border-[var(--color-gray-700)] rounded-xl p-5 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
