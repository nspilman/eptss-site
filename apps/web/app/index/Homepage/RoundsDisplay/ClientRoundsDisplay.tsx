...
import { RoundCard, Button, Badge, Card, CardContent } from "@eptss/ui";
        ...
        >
          <div className="grid gap-6">
            {displayedRounds.map((round, index) => {
              ...
              return (
                <Link href={`round/${round.slug}`} key={round.roundId}>
                  <Card asChild className={`${isCurrent ? 'bg-[var(--color-gray-800)] opacity-60 border-[var(--color-accent-primary)]' : 'bg-[var(--color-background-tertiary)] hover:border-[var(--color-gray-700)]'} transition-all duration-200`}>
                    <motion.div
