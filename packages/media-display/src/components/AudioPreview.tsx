...
export interface AudioPreviewProps {
  ...
  onEnded?: () => void;
  /** External active state for playlist integration */
  isActive?: boolean;
}
...
export const AudioPreview: React.FC<AudioPreviewProps> = ({
  ...
  }, [file, src, showWaveform, waveColor, progressColor, height, containerElement, onEnded]);

  // Handle external isActive changes for playlist integration
  useEffect(() => {
    if (isActive !== undefined && wavesurferRef.current && !isLoading) {
